...
const translations = {
  en: {
    ...
    settingEnableImageLocationPromptsName: "Enable image location prompts",
    settingEnableImageLocationPromptsDesc:
      "Show an Add place button near preview images when Geo Capture can resolve photo GPS.",
    settingImagePromptPositionName: "Image prompt position",
    settingImagePromptPositionDesc: "Choose where the preview image prompt appears.",
    imagePromptBelowImage: "Below image",
    imagePromptInline: "Inline",
    settingAutoDetectImageExifName: "Auto detect local image EXIF",
    settingAutoDetectImageExifDesc: "Read GPS from local JPG/JPEG files before showing image prompts.",
    settingAutoDetectMediaSyncMetadataName: "Auto detect R2 metadata",
    settingAutoDetectMediaSyncMetadataDesc:
      "Use Cloudflare Media Sync metadata when the local image is unavailable or has no EXIF GPS.",
    ...
    imagePromptAddPlace: "Add place",
    imagePromptUpdatePlace: "Update place",
    imagePromptGpsReady: "GPS ready",
    imagePromptSearching: "Finding photo GPS...",
    imagePromptNoGps: "No photo GPS",
    noticeImagePromptInsertFailed: "Geo Capture: unable to insert the selected place for this image.",
  ...
  "zh-TW": {
    ...
    settingEnableImageLocationPromptsName: "啟用圖片定位提示",
    settingEnableImageLocationPromptsDesc:
      "當 Geo Capture 可解析照片 GPS 時，在預覽圖片附近顯示「加入地點」按鈕。",
    settingImagePromptPositionName: "圖片提示位置",
    settingImagePromptPositionDesc: "選擇預覽圖片定位提示要顯示的位置。",
    imagePromptBelowImage: "圖片下方",
    imagePromptInline: "行內",
    settingAutoDetectImageExifName: "自動偵測本機圖片 EXIF",
    settingAutoDetectImageExifDesc: "顯示圖片提示前，先從本機 JPG/JPEG 讀取 GPS。",
    settingAutoDetectMediaSyncMetadataName: "自動偵測 R2 metadata",
    settingAutoDetectMediaSyncMetadataDesc:
      "當本機圖片不可用或沒有 EXIF GPS 時，使用 Cloudflare Media Sync metadata。",
    languageSystem: "系統",
    languageEnglish: "English",
    languageZhTw: "繁體中文",
    languageZhCn: "简体中文",
    ...
    imagePromptAddPlace: "加入地點",
    imagePromptUpdatePlace: "更新地點",
    imagePromptGpsReady: "GPS 可用",
    imagePromptSearching: "正在尋找照片 GPS...",
    imagePromptNoGps: "無照片 GPS",
    noticeImagePromptInsertFailed: "Geo Capture：無法將選擇的地點插入這張圖片。",
  ...
  "zh-CN": {
    ...
    settingEnableImageLocationPromptsName: "启用图片定位提示",
    settingEnableImageLocationPromptsDesc:
      "当 Geo Capture 可解析照片 GPS 时，在预览图片附近显示“加入地点”按钮。",
    settingImagePromptPositionName: "图片提示位置",
    settingImagePromptPositionDesc: "选择预览图片定位提示要显示的位置。",
    imagePromptBelowImage: "图片下方",
    imagePromptInline: "行内",
    settingAutoDetectImageExifName: "自动检测本地图片 EXIF",
    settingAutoDetectImageExifDesc: "显示图片提示前，先从本地 JPG/JPEG 读取 GPS。",
    settingAutoDetectMediaSyncMetadataName: "自动检测 R2 metadata",
    settingAutoDetectMediaSyncMetadataDesc:
      "当本地图片不可用或没有 EXIF GPS 时，使用 Cloudflare Media Sync metadata。",
    languageSystem: "系统",
    languageEnglish: "English",
    languageZhTw: "繁體中文",
    languageZhCn: "简体中文",
    ...
    imagePromptAddPlace: "加入地点",
    imagePromptUpdatePlace: "更新地点",
    imagePromptGpsReady: "GPS 可用",
    imagePromptSearching: "正在寻找照片 GPS...",
    imagePromptNoGps: "无照片 GPS",
    noticeImagePromptInsertFailed: "Geo Capture：无法将选择的地点插入这张图片。",
